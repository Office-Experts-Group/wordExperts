// app/popup-forms/popupFormsSchema.js

// FAQPage structured data for the popup-forms page.
// Built from the plain faqs array so the questions and answers used on-page
// stay in sync with what's marked up for search engines.
const popupFormsSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Popup forms guide users step-by-step through data input, validating each entry to minimise errors and maintain document consistency.",
      },
    },
    {
      "@type": "Question",
...
export default popupFormsSchema;
