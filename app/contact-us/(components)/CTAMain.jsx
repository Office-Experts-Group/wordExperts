  ...
  return (
    ...
    >
      <div className={styles.contactGroup}>
        ...
        {/* Plead section */}
        <div className={styles.plead} style={{ padding: "0 4vw" }}>
          {general ? (
            <a href="mailto:consult@wordexperts.com.au">
        ...
        >
          {general ? "Account Enquiries" : "General Enquiries"}
        </button>
      </div>
    </div>
  );
