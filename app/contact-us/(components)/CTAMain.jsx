...
const CTAMain = () => {
  return (
    <div className={styles.contactAlternate}>
      <div className={styles.contactGroupAlternate}>
        <div className={styles.contactTextAlternate}>
          <div className={styles.svgWrapper}>
            <div className={`${styles.svgImgAlt}`}>
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
