    ...
    >
      {isHidden ? (
        ...
        >
          ...
          <h3>Contents</h3>
          <a href="#stuck" onClick={(e) => handleLinkClick(e, "#stuck")}>
            <div className={styles.contentLink}>
              <p>Stuck on an Old Version?</p>
            </div>
          </a>
          <a href="#issues" onClick={(e) => handleLinkClick(e, "#issues")}>
            <div className={styles.contentLink}>
              <p>Word Migration Issues?</p>
            </div>
          </a>
          ...
          <a
            href="#we-can-help"
            onClick={(e) => handleLinkClick(e, "#we-can-help")}
          >
            <div className={styles.contentLink}>
              <p>Fix Your Word Issues</p>
            </div>
          </a>
        </div>
      )}
