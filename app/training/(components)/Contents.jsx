      ...
      {isHidden ? (
        ...
        >
          ...
          <a
            ...
            onClick={(e) => handleLinkClick(e, "#word-assistance")}
          >
            <div className={styles.contentLink}>
              <p>Microsoft Word Assistance</p>
            </div>
          </a>
          <a
            href="#word-training"
            onClick={(e) => handleLinkClick(e, "#word-training")}
          >
            <div className={styles.contentLink}>
              <p>Microsoft Word Training</p>
            </div>
          </a>
          <a
            href="#document-solutions"
            onClick={(e) => handleLinkClick(e, "#document-solutions")}
          >
            <div className={styles.contentLink}>
