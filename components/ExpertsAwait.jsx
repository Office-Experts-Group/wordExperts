      ...
      <AnimateOnScroll animation="slide-left" delay={0.1} duration={1.2}>
        <div className={styles.content}>
          ...
          <div className={styles.text}>
            <p>
              Contact us today to discover how Word Experts can transform your
              document management and protect your corporate identity with
              professional template solutions.
            </p>
